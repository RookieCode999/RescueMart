...
<?php
	...
	$stmt0 = $conn->query("SELECT name,balance FROM rescuemart.seller where sid = $sid;");
...
<body>
	...
	<?php
	$i=1;
	$stmt = $conn->query("SELECT pid,cid,proName,shopName,trans_time,price FROM rescuemart.transaction where sid = $sid;");
