...
if(isset($_POST['submit']) ){
	...
	$sql = "INSERT INTO rescuemart.shop(ownerSid,shopName,shopCategory,shopInfo,shopAddress,shopEmail,ShopContact) VALUES(:o,:n,:c,:i,:a,:e,:con)";
	...
	$name = $_POST['shopName'];
	$stmt = $conn->query("SELECT max(shopId) as shopId FROM rescuemart.shop where ownerSid = $ownerSid");
